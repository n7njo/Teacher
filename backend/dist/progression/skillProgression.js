...
exports.SkillProgressionManager =
...
class SkillProgressionManager {
  ...
  initializeSkills() {
    Object.entries(exports.skillLevels).forEach(([skillName, skillData]) => {
  ...
  isSkillCompleted(skillName) {
    const skill = this.userSkills.get(skillName);
    return skill
      ? skill.currentLevel === skill.levels.length - 1 && skill.progress === 100
      : false;
  }
  getRecommendedLearningPath(completedSkills) {
    return exports.learningPaths
      .filter((path) => {
...
exports.SkillProgressionManager = SkillProgressionManager;
//# sourceMappingURL=skillProgression.js.map
