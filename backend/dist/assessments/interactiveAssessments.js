...
exports.InteractiveElementFactory =
  exports.AssessmentManager =
  exports.questionBanks =
  exports.interactiveElements =
  exports.assessmentTemplates =
    void 0;
exports.assessmentTemplates = {
  formativeQuiz: {
...
class AssessmentManager {
  ...
  createAssessment(template, customizations) {
    const assessment = {
      ...template,
      ...customizations,
  ...
  submitResponse(assessmentId, userId, responses) {
  ...
  calculateScore(assessment, responses) {
  ...
  getAssessmentResults(assessmentId, userId) {
    const responseKey = `${assessmentId}-${userId}`;
    return this.responses.get(responseKey);
  }
  generateFeedback(assessment, responses) {
    const feedback = [];
    responses.forEach((response, index) => {
      if (!response.isCorrect) {
        feedback.push(
...
class InteractiveElementFactory {
  static createCodeEditor(config = {}) {
    const defaultConfig =
      exports.interactiveElements.javaScriptCodeEditor.config;
    return {
      ...exports.interactiveElements.javaScriptCodeEditor,
      config: { ...defaultConfig, ...config },
    };
  }
  static createQuiz(config = {}) {
    const defaultConfig = exports.interactiveElements.multipleChoiceQuiz.config;
    return {
      ...exports.interactiveElements.multipleChoiceQuiz,
      config: { ...defaultConfig, ...config },
    };
  }
  static createVisualization(config = {}) {
    const defaultConfig =
      exports.interactiveElements.algorithmVisualization.config;
    return {
      ...exports.interactiveElements.algorithmVisualization,
      config: { ...defaultConfig, ...config },
    };
  }
  static createSandbox(config = {}) {
    const defaultConfig = exports.interactiveElements.reactSandbox.config;
    return {
      ...exports.interactiveElements.reactSandbox,
      config: { ...defaultConfig, ...config },
    };
  }
  static createTerminal(config = {}) {
    const defaultConfig = exports.interactiveElements.terminalEmulator.config;
    return {
      ...exports.interactiveElements.terminalEmulator,
      config: { ...defaultConfig, ...config },
    };
  }
}
exports.InteractiveElementFactory = InteractiveElementFactory;
//# sourceMappingURL=interactiveAssessments.js.map
