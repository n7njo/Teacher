// Claude Flow Curriculum Type Definitions
// Comprehensive type system for enhanced learning platform
...
// Enhanced lesson structure for Claude Flow
export interface EnhancedLesson {
  ...
  prerequisites: string[]; // lesson IDs or concept names
