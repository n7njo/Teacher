// Claude Flow Coding Exercises
// Comprehensive library of hands-on coding exercises for different skill levels

import { Exercise, TestCase, CodeExample } from "../types/curriculum";
...
export const exerciseCategories: ExerciseCategory[] = [
  ...
  },
  {
    ...
    exercises: [
      ...beginnerExercises.slice(2),
      ...intermediateExercises.slice(0, 2),
    ],
  },
  {
    ...
    exercises: intermediateExercises.slice(2),
  },
  {
...
export function getExercisesByDifficulty(difficulty: string): Exercise[] {
  return exerciseLibrary[difficulty as keyof ExerciseLibrary] || [];
}
